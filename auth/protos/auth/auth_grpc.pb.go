...
func (c *authClient) Test(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedAuthServer) Test(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Auth_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Test(ctx, req.(*HelloRequest))
	}
